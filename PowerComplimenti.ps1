<#
    ...
    raffaele File: PowerComplimenti.ps1
...
filter Export-PowerComplimentiCSV {
<#
    .SYNOPSIS
        ...
        PowerComplimenti has a thread-safe way to export output to the same file.
    ...
    process {
        if($UserSearcher) {
            ...
            $Results | Where-Object {$_} | ForEach-Object {
                ...
                $User.PSObject.TypeNames.Add('PowerComplimenti.User')
                $User
            }
            $Results.dispose()
                ...
                $Results | Where-Object {$_} | ForEach-Object {
                    ...
                    if($Up) {
                        ...
                        if ($FullData) {
                            ...
                            $Computer.PSObject.TypeNames.Add('PowerComplimenti.Computer')
                            $Computer
                        }
                        else {
            ...
            try {
                ...
                $Results | Where-Object {$_} | ForEach-Object {
                    if ($FullData) {
                        ...
                        $OU.PSObject.TypeNames.Add('PowerComplimenti.OU')
                        $OU
                    }
                    else { 
            ...
            try {
                ...
                $Results | Where-Object {$_} | ForEach-Object {
                    if ($FullData) {
                        ...
                        $Site.PSObject.TypeNames.Add('PowerComplimenti.Site')
                        $Site
                    }
                    else {
                    ...
                    $UserDirectoryEntry.TokenGroups | ForEach-Object {
                        ...
                        if($GroupSid -notmatch '^S-1-5-32-.*') {
                            if($FullData) {
                                ...
                                $Group.PSObject.TypeNames.Add('PowerComplimenti.Group')
                                $Group
                            }
                            else {
                                if($RawSids) {
        ...
        if ($GroupSearcher) {
            ...
            $Members | Where-Object {$_} | ForEach-Object {
                ...
                if($Properties) {
                    ...
                    $GroupMember.PSObject.TypeNames.Add('PowerComplimenti.GroupMember')
                    $GroupMember
    ...
    $GPOgroups | ForEach-Object {
        ...
        Get-NetOU -Domain $Domain -DomainController $DomainController -GUID $GPOguid -FullData -PageSize $PageSize | ForEach-Object {
            ...
            if($OUComputers) {
                ...
                ForEach ($TargetSid in $TargetObjectSIDs) {
                    ...
                    $GPOLocation.PSObject.TypeNames.Add('PowerComplimenti.GPOLocalGroup')
                    $GPOLocation
                }
            }
        }
        ...
        Get-NetSite -Domain $Domain -DomainController $DomainController -GUID $GPOguid -PageSize $PageSize -FullData | ForEach-Object {
            ...
            ForEach ($TargetSid in $TargetObjectSIDs) {
                ...
                $AppliedSite.PSObject.TypeNames.Add('PowerComplimenti.GPOLocalGroup')
                $AppliedSite
            }
        }
    }
                ...
                if (($Result -eq 0) -and ($Offset -gt 0)) {
                    ...
                    for ($i = 0; ($i -lt $EntriesRead); $i++) {
                        ...
                        if($Result2 -eq 0) {
                            ...
                            $LocalUser.PSObject.TypeNames.Add('PowerComplimenti.LocalUserAPI')
                ...
                try {
                    if($ListGroups) {
                        ...
                        $Computer.psbase.children | Where-Object { $_.psbase.schemaClassName -eq 'group' } | ForEach-Object {
                            ...
                            $Group.PSObject.TypeNames.Add('PowerComplimenti.LocalGroup')
                            $Group
                        }
                    }
                    else {
                        ...
                        $Members | ForEach-Object {
                            ...
                            $Member.PSObject.TypeNames.Add('PowerComplimenti.LocalUser')
                            $Member
...
#>
    ...
    process {
        ...
        Get-ChildItem @SearchArgs | ForEach-Object {
            ...
            if($OutFile) {Export-PowerComplimentiCSV -InputObject $_ -OutFile $OutFile}
            else {$_}
        }
    }
...
function Invoke-ThreadedFunction {
    ...
    begin {
        ...
        # import the current session state's variables and functions so the chained PowerComplimenti
                        ...
                        ForEach ($Session in $Sessions) {
                            ...
                            if (($UserName) -and ($UserName.trim() -ne '') -and (!($UserName -match $CurrentUser))) {
                                ...
                                $TargetUsers | Where-Object {$UserName -like $_.MemberName} | ForEach-Object {
                                    ...
                                    $FoundUser.PSObject.TypeNames.Add('PowerComplimenti.UserSession')
                                    $FoundUser
                                }
                            }
                        }
    ...
    .EXAMPLE
     ...
     .NOTES
       ...
       Author:  Scott Sutherland - 2015, NetSPI
                Modifications to integrate into PowerComplimenti by @harmj0y
       ...
       Will Schroeder's "Invoke-FindVulnSystems" function from the PowerComplimenti toolkit.
#>
    [CmdletBinding()]
    Param(
        [Parameter(ValueFromPipeline=$True)]
        ...
        $HostEnumBlock = {
            ...
            if($Up) {
                ...
                if($LocalAdmins -and ($LocalAdmins.Length -ne 0)) {
                    ...
                    if($OutFile) {
                        $LocalAdmins | Export-PowerComplimentiCSV -OutFile $OutFile
                    }
                    else {
        ...
        if($LDAP -or $ADSPath) {
            ...
            if($TrustSearcher) {
                ...
                $Results | Where-Object {$_} | ForEach-Object {
                    ...
                    $DomainTrust.PSObject.TypeNames.Add('PowerComplimenti.DomainTrustLDAP')
                    $DomainTrust
                }
                $Results.dispose()
        ...
        elseif($API) {
                ...
                if (($Result -eq 0) -and ($Offset -gt 0)) {
                    ...
                    for ($i = 0; ($i -lt $DomainCount); $i++) {
                        ...
                        if($Result -eq 0) {
                            ...
                            $DomainTrust.PSObject.TypeNames.Add('PowerComplimenti.APIDomainTrust')
                            $DomainTrust
                        }
                    }
                    # free up the result buffer
            ...
            if($FoundDomain) {
                $FoundDomain.GetAllTrustRelationships() | ForEach-Object {
                    $_.PSObject.TypeNames.Add('PowerComplimenti.DomainTrust')
                    $_
                }
            }
        }
    ...
    process {
        ...
        if($FoundForest) {
            $FoundForest.GetAllTrustRelationships() | ForEach-Object {
                $_.PSObject.TypeNames.Add('PowerComplimenti.ForestTrust')
                $_
            }
        }
    }
...
<#
    ...
    .EXAMPLE
        ...
        PS C:\> Find-ManagedSecurityGroups | Export-PowerComplimentiCSV -NoTypeInformation group-managers.csv
                ...
                if ($Trusts) {
                    ...
                    ForEach ($Trust in $Trusts) {
                        if($Trust.SourceName -and $Trust.TargetName) {
                            ...
                            $ObjectType = $Trust.PSObject.TypeNames | Where-Object {$_ -match 'PowerComplimenti'} | Select-Object -First 1
